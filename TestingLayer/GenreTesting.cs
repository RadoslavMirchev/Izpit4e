...
namespace TestingLayer
{
    ...
    {
        private RadoslavMirchev11eDbContext dbContext;
        ...
        public void Setup()
        {
            ...
            dbContext = new RadoslavMirchev11eDbContext(builder.Options);
        ...
        public void TestCreateGenre()
        {
            ...
            genreContext.Create(new Genre("Soulslike"));
        ...
        public void TestUpdateGenre()
        {
            ...
            genre.Name = "Roguelike";

            genreContext.Update(genre);

            Genre genre1 = genreContext.Read(1);

            Assert.IsTrue(genre1.Name == "Roguelike", "Genre Update() does not change name!");
        }
